...
def plot_data(country, y_axis):
    ...
    if y_axis == "lifeExp":
        fig = px.line(
            ...
            x="year",
            y="lifeExp",
            title=f"{country} - Life expectancy",
        )
        st.plotly_chart(fig)
    elif y_axis == "pop":
        fig = px.line(
...
def plot_data(continent, y_axis):
    ...
    if y_axis == "lifeExp":
        fig = px.line(
            df_continent[df_continent.continent == continent],
            x="year",
            y="lifeExp",
            title=f"{continent} - Life expectancy",
        )
        st.plotly_chart(fig)
    elif y_axis == "pop":
        fig = px.line(
        ...
        fig = px.line(
            ...
            x="year",
            y="gdpPercap",
            title=f"{continent} - GDP per capita",
        )
        st.plotly_chart(fig)
